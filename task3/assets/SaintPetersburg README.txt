...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=SaintPetersburg&box=30.427867,60.020505,30.086295,59.849826
...
-----------
  ...
  * SaintPetersburg Height Map (ASTER 30m).png
  ...
  * SaintPetersburg Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * SaintPetersburg Height Map (SRTM3 v4.1).png
  ...
  * SaintPetersburg Height Map (SRTM30 Plus).png
